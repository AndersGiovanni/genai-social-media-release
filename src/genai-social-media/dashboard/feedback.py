...
from treatments.treatment_info import display_feedback_metrics, display_feedback_metrics_by_topic
...
def main():
    ...
    st.header("Treatment 3: Feedback Analysis")
    st.markdown("Here we look at how the users used the feedback feature.")

    feedback_metrics = display_feedback_metrics(player_round_data)

    st.divider()
    st.subheader("Feedback Metrics by Topic")
    topics_feedback_metrics = display_feedback_metrics_by_topic(player_round_data)
